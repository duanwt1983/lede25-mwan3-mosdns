...
assert_grep 'function dingtalk_compose_text' "$_LEDE_FILES/usr/libexec/wan-alert"
assert_grep 'function pushplus_content' "$_LEDE_FILES/usr/libexec/wan-alert"
assert_absent 'compose_text(detail)' "$_LEDE_FILES/usr/libexec/wan-alert"
...
assert_grep 'pushplus_prefix' "$_LEDE_FILES/www/luci-static/resources/view/status/alertmap.js"
assert_grep "depends('enabled', '1')" "$_LEDE_FILES/www/luci-static/resources/view/status/alertmap.js"
assert_grep "depends('pushplus_enabled', '1')" "$_LEDE_FILES/www/luci-static/resources/view/status/alertmap.js"
assert_grep 'function sendAlertTest' "$_LEDE_FILES/www/luci-static/resources/view/status/alertmap.js"
assert_grep 'wanalert-push-row' "$_LEDE_FILES/www/luci-static/resources/view/status/wanalert-layout.js"
assert_grep '官网链接' "$_LEDE_FILES/www/luci-static/resources/view/status/wanalert-layout.js"
assert_grep 'LINK_IDLE_BPS' "$_LEDE_FILES/www/luci-static/resources/view/status/index.js"
